...
export class StockAlertApi implements ICredentialType {
	...
	properties: INodeProperties[] = [
		...
		},
		{
			...
			description: 'The base URL for your StockAlert instance (without /v1)',
		},
	];
	...
	test: ICredentialTestRequest = {
		request: {
			baseURL: '={{$credentials.environment === "production" ? "https://api.stockalert.pro" : $credentials.customUrl}}/v1',
			url: '/alerts?limit=1',
		},
	};
}